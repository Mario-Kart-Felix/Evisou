...
using System.Linq;
using System.Web;
using Evious.Ims.Contract.sfc;
using Evious.Ims.Contract.Model.PayPal;

namespace Evious.Ims.Contract.Model.SFC
{
    public class SFCAPI : ICarrier
    {
        ...
        public ShipOrder AddExpressOrder(DispatchRequest dispatchrequest, TransactionDetail transactiondetail)
        {
            ...
            addOrderRequestInfo.goodsDeclareWorth = float.Parse(dispatchrequest.goodsDeclareWorth.ToString());//
            addOrderRequestInfo.goodsDeclareWorthSpecified = true;
            addOrderRequestInfo.isReturn = "1";
            addOrderRequestInfo.evaluate = float.Parse(dispatchrequest.goodsDeclareWorth.ToString()) + 1;
            ...
            {
                detailWorth = float.Parse(dispatchrequest.goodsDeclareWorth.ToString()),
                detailQuantity = 1,

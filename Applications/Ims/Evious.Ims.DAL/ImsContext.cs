...
namespace Evious.Ims.DAL
{
   public class ImsContext : DbContextBase
    {
       public ImsContext()
          : base("Server = 192.169.63.61; Database =EviousIms; User ID = WebDb; Password=Hi6327582; Integrated Security=false;MultipleActiveResultSets=true")
            //: base("Server = .; Database =EviousIms; User ID = sa; Password=123456; Integrated Security=false;MultipleActiveResultSets=true")
        {

...
using Evious.Ims.Contract.Model.CK1BFE;
using Evious.Ims.Contract.Model.SFC;
...
namespace Evious.Ims.BLL
{
    ...
    public class ImsService : IImsService, IPayPalHelper
    {
        ...
        public Evious.Ims.Contract.Model.PayPal.PaymentTransactionType GetPaymentTransaction(int id)
        {
            using (var dbContext = new ImsDbContext())
            {
                var transactiondetails = dbContext.PayPalPaymentTransactions.Include(i => i.PaymentInfo)
                                                                           ...
                                                                           // .Include(c => c.PaymentItemInfo.PaymentItem)
                                                                            ...
                                                                            .Where(c => c.ID == id)
                                                                            .FirstOrDefault<Evious.Ims.Contract.Model.PayPal.PaymentTransactionType>();
                List<Evious.Ims.Contract.Model.PayPal.PaymentItemType> PaymentItems = new List<Contract.Model.PayPal.PaymentItemType>();
        ...
        public IEnumerable<Evious.Ims.Contract.Model.PayPal.PaymentTransactionType> GetPaymentTransactionList(PaymentTransactionRequest request = null)
        {
            request = request ?? new PaymentTransactionRequest();

            using (var dbContext = new ImsDbContext())
            {
                IQueryable<Evious.Ims.Contract.Model.PayPal.PaymentTransactionType> paymenttransactionlist =
        ...
        public void SavePaymentTransaction(Evious.Ims.Contract.Model.PayPal.PaymentTransactionType paymenttransaction)
        {
            using (var dbContext = new ImsDbContext())
            {
                if (paymenttransaction.ID > 0)
                {
                    dbContext.Update<Evious.Ims.Contract.Model.PayPal.PaymentTransactionType>(paymenttransaction);
                }
                else
                {
                    dbContext.Insert<Evious.Ims.Contract.Model.PayPal.PaymentTransactionType>(paymenttransaction);
                }
            }
        }
        ...
        public List<Evious.Ims.Contract.Model.PayPal.PaymentItemType> DistinctPaymentItemInfo()
        {
            var mItems = new HashSet<string>(this.GetAssociationList().Select(c => c.ItemTitle));

            List<Evious.Ims.Contract.Model.PayPal.PaymentItemType> TransactionItems = new List<Evious.Ims.Contract.Model.PayPal.PaymentItemType>();

            foreach (Evious.Ims.Contract.Model.PayPal.PaymentTransactionType detail in this.GetPaymentTransactionList())
            {
                if (detail.PaymentItemInfo != null)
                {
                    foreach (Evious.Ims.Contract.Model.PayPal.PaymentItemType item in detail.PaymentItemInfo.PaymentItem)
                    {
                        if (!mItems.Contains(item.Name))
                        {
                            TransactionItems.Add(new Evious.Ims.Contract.Model.PayPal.PaymentItemType
                            {
                                Number=item.Number,
                                Name = item.Name
                            });
        ...
        private List<Evious.Ims.Contract.Model.PayPal.PaymentItemType> GetPaymentItemsInfo()
        {
            List<Evious.Ims.Contract.Model.PayPal.PaymentItemType> paymentitems = new List<Contract.Model.PayPal.PaymentItemType>();
        ...
        public void Sync()
        {
            ...
            foreach (var item in PaypalTransactionSearch)
            {
                ...
                if (PaypalTransactionDetails.Ack.Equals(AckCodeType.SUCCESS))
                {
                    ...
                    //Evious.Ims.Contract.Model.PayPal.PaymentTransactionType detail = this.PaymentTransaction(PaypalTransactionDetails);
                    //using (var dbContext = new ImsDbContext())
                    //{
                    //    Evious.Ims.Contract.Model.PayPal.PaymentTransactionType transactionDetail = new Evious.Ims.Contract.Model.PayPal.PaymentTransactionType();
        ...
        public Evious.Ims.Contract.Model.PayPal.PaymentTransactionType PaymentTransaction(GetTransactionDetailsResponseType getTransactionDetail)
        {
            DateTime now = DateTime.Now;
            Evious.Ims.Contract.Model.PayPal.PaymentTransactionType payment = new Evious.Ims.Contract.Model.PayPal.PaymentTransactionType();
            ...
            {
               Address = new Evious.Ims.Contract.Model.PayPal.AddressType
                {
            ...
            foreach (var item in getTransactionDetail.PaymentTransactionDetails.PaymentItemInfo.PaymentItem)
            {
                ...
                //  List<Evious.Ims.Contract.Model.PayPal.AdditionalFeeType> AdditionalFees = new List<Contract.Model.PayPal.AdditionalFeeType>();

                //  if (item.InvoiceItemDetails!=null)
                //  {
                //      foreach (var addtionalfee in item.InvoiceItemDetails.AdditionalFees)
                //      {
                //          AdditionalFees.Add(new Evious.Ims.Contract.Model.PayPal.AdditionalFeeType()
                //          {
                ...
                //  }
                 ...
                 #region Discount
                // List<Evious.Ims.Contract.Model.PayPal.DiscountType> Discount = new List<Contract.Model.PayPal.DiscountType>();

                // if (item.InvoiceItemDetails != null)
                // {
                //     foreach (var item_discount in item.InvoiceItemDetails.Discount)
                //     {
                //         Discount.Add(new Evious.Ims.Contract.Model.PayPal.DiscountType
                //         {
        ...
        */
        ...
        public void SaveAssociation(Association association)
        {
            using (var dbContext = new ImsDbContext())
            {
                ...
                List<Evious.Ims.Contract.Model.PayPal.PaymentItemType> PaymentItems = GetPaymentItemsInfo();
                PaymentItems.Where(i => i.Number == association.ItemNumber).ToList().ForEach(a =>
                {
                    a.AssociationID = association.ID;
                    dbContext.Update<Evious.Ims.Contract.Model.PayPal.PaymentItemType>(a);
                });       
                ...
                //{
                //    item.AssociationID = association.ID;
                //    dbContext.Update<Evious.Ims.Contract.Model.PayPal.PaymentItemType>(item);
                //}
        ...
        public ShipOrder AddDispatchOrder(DispatchRequest request, Evious.Ims.Contract.Model.PayPal.PaymentTransactionType paymenttransaction)
        {
        ...
        public ShipOrder SaveDispatchOrder(DispatchRequest request, Evious.Ims.Contract.Model.PayPal.PaymentTransactionType paymenttransaction)
        {
        ...
        public string DeleteDispatchOrder(Evious.Ims.Contract.Model.PayPal.PaymentTransactionType paymenttransaction)
        {
        ...
        public string SubmitDispatchOrder(Evious.Ims.Contract.Model.PayPal.PaymentTransactionType paymenttransaction)
        {
        ...
        #endregion
        public IEnumerable<Evious.Core.Log.AuditLog> GetAuditLogList(AuditLogRequest request = null)
        {

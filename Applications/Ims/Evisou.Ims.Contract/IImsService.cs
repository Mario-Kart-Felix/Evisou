...
namespace Evisou.Ims.Contract
{
    public interface IImsService : IPayPalHelper
    {
        ...
        Evisou.Ims.Contract.Model.PayPal.PaymentTransactionType GetPaymentTransaction(int id);
        IEnumerable<Evisou.Ims.Contract.Model.PayPal.PaymentTransactionType> GetPaymentTransactionList(PaymentTransactionRequest request = null);
        void SavePaymentTransaction(Evisou.Ims.Contract.Model.PayPal.PaymentTransactionType paymenttransaction);
        ...
        ShipOrder AddDispatchOrder(DispatchRequest request, Evisou.Ims.Contract.Model.PayPal.PaymentTransactionType paymenttransaction);
        ...
        string DeleteDispatchOrder(Evisou.Ims.Contract.Model.PayPal.PaymentTransactionType paymenttransaction);

        string SubmitDispatchOrder(Evisou.Ims.Contract.Model.PayPal.PaymentTransactionType paymenttransaction);
        ...
        IEnumerable<Evisou.Core.Log.AuditLog> GetAuditLogList(AuditLogRequest request = null);

var ComponentsFormTools = function () {
    ...
    var handleTwitterTypeahead = function() {
        ...
        var countries = new Bloodhound({
          ...
          limit: 10,
          prefetch: {
              url: '',//'angularjs/demo/typeahead_countries.json',
        ...
        var custom = new Bloodhound({
          ...
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          remote: 'angularjs/demo/typeahead_custom.php?query=%QUERY'
        });
        ...
        var nba = new Bloodhound({
          ...
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          prefetch: 'angularjs/demo/typeahead_nba.json'
        });
         
        var nhl = new Bloodhound({
          datumTokenizer: function(d) { return Bloodhound.tokenizers.whitespace(d.team); },
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          prefetch: 'angularjs/demo/typeahead_nhl.json'
        });
    ...
    var handleUsernameAvailabilityChecker1 = function () {
        ...
        $("#username1_checker").click(function (e) {
            ...
            $.post('angularjs/demo/username_checker.php', {
                username: input.val()
            }, function (res) {

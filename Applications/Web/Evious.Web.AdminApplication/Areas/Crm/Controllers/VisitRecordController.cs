    ...
    public class VisitRecordController : AdminControllerBase
    {
       ...
       public ActionResult Datatable(VisitRecordRequest request)
       {
           ...
           Func<VisitRecord, string> orderingFunction = (c =>
                                               ...
                                               sortColumnIndex == 4 && isVisitWaySortable ? Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumVisitWay)c.VisitWay):
                                               ...
                                               sortColumnIndex == 7 && isMotivationSortable ? Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumMotivation)c.Motivation) :
                                               sortColumnIndex == 8 && isAreaDemandSortable ? Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumAreaDemand)c.AreaDemand):
                                               sortColumnIndex == 9 && isPriceResponseSortable ? Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumPriceResponse)c.PriceResponse):
                                               sortColumnIndex == 10 && isCognitiveChannelSortable ? StringUtil.CutString(Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumCognitiveChannel)c.CognitiveChannel), 20):
                                               sortColumnIndex == 11&& isFocusSortable ? StringUtil.CutString(Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumFocus)c.Focus), 20):
           ...
           var result = from c in displayedVisitRecord
                        select new[] {  
                                            ...
                                            , Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumVisitWay)c.VisitWay)
                                            ...
                                            , Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumMotivation)c.Motivation)
                                            , Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumAreaDemand)c.AreaDemand)
                                            ,Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumPriceResponse)c.PriceResponse)
                                            ,StringUtil.CutString(Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumCognitiveChannel)c.CognitiveChannel), 20)
                                            ,StringUtil.CutString(Evious.Framework.Utility.EnumHelper.GetEnumTitle((EnumFocus)c.Focus), 20)
                                            ,c.Username

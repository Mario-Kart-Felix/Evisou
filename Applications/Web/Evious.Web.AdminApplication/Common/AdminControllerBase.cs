    ...
    public abstract class AdminControllerBase : ControllerBase
    {
        ...
        protected override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            else
            {
                ...
                {
                    filterContext.Result = RedirectToAction("UnLock", "Auth", new { Area = "Account" });
                    return;
                    //if (Request.RawUrl.ToString().Contains(Url.Action("Logout", "Auth", new { Area = "Account" })))
                    //{
                    //    filterContext.Result = RedirectToAction("Logout", "Auth", new { Area = "Account" });
                    //    filterContext.Result = RedirectToAction("Login", "Auth", new { Area = "Account" });
                    //    return;
                    //}
                    //else
                    //{
                    //    filterContext.Result = RedirectToAction("Lock", "Auth", new { Area = "Account" });
                    //    return;
                    //}                   
                }
            }

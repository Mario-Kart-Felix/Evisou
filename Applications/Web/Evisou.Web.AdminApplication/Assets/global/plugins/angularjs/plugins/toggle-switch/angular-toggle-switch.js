  ...
  module.directive('toggleSwitch',['toggleSwitchConfig', function (toggleSwitchConfig) {
    return {
      ...
      template: '<div role="radio" class="toggle-switch" ng-class="{ \'disabled\': disabled }">' +
          ...
          '</div>' +
          '</div>',
      //template: '<div class="bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-id-aa bootstrap-switch-animate" ng-class="{\'bootstrap-switch-off\': !model, \'bootstrap-switch-on\': model}">' +
      //          '<div class="bootstrap-switch-container" ng-class="{ \'disabled\': disabled }">' +
      //          '<span class="bootstrap-switch-handle-on bootstrap-switch-primary" ng-bind="onLabel"></span>' +
      //          '<span class="bootstrap-switch-label"></span></span>' +
      //          '<span class="bootstrap-switch-handle-off bootstrap-switch-default" ng-bind="offLabel"></span>' +
      //          '</div>'+
      //          '</div>',
